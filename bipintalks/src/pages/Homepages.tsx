    ...
    return (
        <>
            <div className="relative w-full h-[100vh] md:h-[130vh]">
                ...
                />
                <div className="absolute inset-0 bg-[#212020] opacity-[0.80] flex items-center justify-left pt-[30px] ">
                    <div className="text-left text-white px-4 py-2 md:ml-[130px] md:w-[50%] w-full">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold leading-snug animate-textd">
                            Welcome to <span className="block leading-snug">Bipin Talks!</span>
                        </h1>
                        <p className="text-sm sm:text-base md:text-[17px] font-extralight leading-relaxed mt-4 md:mt-10 animate-textd">
                            Welcome to Bipin Talks, your destination for exploring engineering, technology, products, and software.
                        </p>
                        <p className="text-sm sm:text-base md:text-[17px] font-extralight leading-relaxed mt-4 md:mt-6 animate-textd">
