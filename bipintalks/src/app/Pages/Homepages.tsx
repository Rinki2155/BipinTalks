  ...
  return (
    <>
      <div className="relative w-full h-[100vh] md:h-[130vh]">
        ...
        />
        <div className="absolute inset-0 bg-[#212020] opacity-[0.90] flex items-center justify-left p-4">
          <div className="text-left text-white px-4 py-2 md:ml-[130px] md:w-[50%] w-full">
            <h1 className="text-5xl md:text-7xl font-bold leading-snug">Welcome where <span className='block leading-snug'>Bipin Talks!</span></h1>
            <p className="text-base md:text-[17px] font-extralight leading-relaxed mt-10">
              Welcome to Bipin Talks, your destination for exploring engineering, technology, products, and software.
            </p>
            <p className="text-base md:text-[17px] font-extralight leading-relaxed mt-6">
