  ...
  return (
    <>
      ...
      <div className="flex items-center justify-left pt-[15%] ">
        <div className="text-left text-black px-4 py-2 md:ml-[130px] md:w-[60%] w-full">
          <div className="text-2xl sm:text-3xl md:text-5xl font-bold leading-snug animate-textd">
            About the author!
          </div>
          <div className="text-2xl sm:text-3xl md:text-5xl leading-snug animate-textd mt-6">
            Welcome to the Author's corner!
          </div>
        </div>
      </div>
      ...
      <div className="w-full min-h-[100vh] flex flex-col items-center justify-center">
        <div className="w-full md:w-[55%] text-center px-4">
          <p className="text-base md:text-[17px] leading-relaxed animate-textd">
            I am passionate about software engineering, technology, programming, and product management.
          </p>
          <p className="text-base md:text-[17px] leading-relaxed mt-6 animate-textd">
            With a background in computer science, I love transforming complex problems into innovative solutions. My journey in tech involves designing scalable architectures, optimizing algorithms, and staying updated with the latest trends. I am committed to creating impactful products by bridging the gap between technology and user needs.
          </p>
          <p className="text-base md:text-[17px] leading-relaxed mt-6 animate-textd">
            Thank you for visiting my website. I look forward to sharing insights and projects with you.
          </p>
          ...
          <div className="flex flex-col items-center mt-10">
            ...
            <p className="text-base md:text-[17px] leading-relaxed mt-2 animate-textd">
              Technical Program Manager, Tata Digital
            </p>
          </div>

          {/* Call to Interaction */}
          <h2 className="text-2xl sm:text-3xl md:text-5xl text-center leading-snug animate-textd mt-10">
            Let's interact
          </h2>
          <p className="text-base md:text-[17px] leading-relaxed mt-6 text-center animate-textd">
            Write to us with your valuable feedback and topics you'd like to read about!
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[100vh] mt-10">
        <div className="w-full md:w-[70%] p-6 space-y-6 bg-purple-100 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-center">Share a Word</h2>
