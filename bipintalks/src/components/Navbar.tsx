          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8 ml-8">
                <Link href="/newStory" className="hover:underline text-[18px]">
                ...
                <div className="relative">
                  {showLinks && (
                    <div className="absolute bg-black top-8 right-0 p-4 rounded-lg shadow-lg w-[200px]">
                      <Link
                        href="/about"
                        target="_blank"
        ...
        {isClick && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 ml-[35px]">
              <Link
                href="/"
                className="hover:underline text-[18px] ml-12"
              ...
              <Link
                href="/write"
                className="hover:underline text-[18px] mb-4 ml-8"
                onClick={closeMobileMenu}
              >
                <PencilSquareIcon className="h-7 w-7 text-black-500" />
              </Link>
              ...
              <Link
                href="/"
                className="block hover:underline text-[18px] mb-4"
                onClick={closeMobileMenu}
              >
                Home
              </Link>
