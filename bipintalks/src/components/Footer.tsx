        ...
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
          ...
          <div className="flex flex-col w-60">
            ...
            <div className="flex space-x-4">
              <Link href="#" aria-label="Facebook" className="text-white hover:text-white transition-colors duration-200">
                <FaFacebookF size={24} />
              </Link>
              <Link href="#" aria-label="Instagram" className="text-white hover:text-white transition-colors duration-200">
                <FaInstagram size={24} />
              </Link>
              <Link href="#" aria-label="Twitter" className="text-white hover:text-white transition-colors duration-200">
                <FaXingSquare size={24} />
              </Link>
              <Link href="https://www.youtube.com/@BipinTalks0207" target="_blank" aria-label="TikTok" className="text-white  hover:text-white transition-colors duration-200">
                <FaYoutube size={24} />
              </Link>
            </div>
          </div>
